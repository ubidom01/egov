     ...
     <div class="container">
      ...
      <section class="card wow fadeIn">
        ...
        <div class="card-body text-dark text-center py-3 px-5 my-1">
          <h1 class="pt-2"><strong>${pageTitle} <spring:message code="title.update" /></strong></h1> <!-- 공지사항 -->
        </div>
        <!--// Content -->
      </section>
      <!--//Section: Jumbotron-->
...
<!-- 타이틀 -->
	...
	<tbody>
		...
		<tr>
			<th><label for="cnsltCn">${title}</label> <span class="pilsu">*</span></th>
			<td class="nopd">
				<form:textarea path="cnsltCn" title="${title} ${inputTxt}" rows="30" style="height:200px;" value="${result.cnsltCn}"/>   
		...
		<tr>
			<th><label for="cnsltCn">${title}</label> <span class="pilsu">*</span></th>
			<td class="nopd">
				<form:textarea path="managtCn" title="${title} ${inputTxt}" rows="30" style="height:200px;" />   
