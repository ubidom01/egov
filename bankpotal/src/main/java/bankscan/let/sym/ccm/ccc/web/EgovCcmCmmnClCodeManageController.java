package bankscan.let.sym.ccm.ccc.web;
...
import bankscan.let.sym.ccm.ccc.service.CmmnClCode;
...
public class EgovCcmCmmnClCodeManageController {
	 ...
	 * @param searchVO
	 * @param model
	 * @return "sym/ccm/ccc/SelectCcmCmmnClCodeList"
	 * @throws Exception
	 */
	 ...
	 * @param cmmnClCode
	 * @param model
	 * @return "sym/ccm/ccc/SelectCcmCmmnClCodeDetail.do"
	 * @throws Exception
	 */
