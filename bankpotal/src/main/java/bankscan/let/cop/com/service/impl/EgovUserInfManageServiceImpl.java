...
import bankscan.let.cop.com.service.EgovUserInfManageService;
import bankscan.let.cop.com.service.UserInfVO;
...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see bankscan.let.cop.com.service.EgovUserInfManageService#selectClubOprtrList(bankscan.let.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see bankscan.let.cop.com.service.EgovUserInfManageService#selectClubUserList(bankscan.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see bankscan.let.cop.com.service.EgovUserInfManageService#selectCmmntyMngrList(bankscan.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see bankscan.let.cop.com.service.EgovUserInfManageService#selectCmmntyUserList(bankscan.let.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see bankscan.let.cop.com.service.EgovUserInfManageService#selectUserList(bankscan.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see bankscan.let.cop.com.service.EgovUserInfManageService#selectAllClubUser(bankscan.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see bankscan.let.cop.com.service.EgovUserInfManageService#selectAllCmmntyUser(bankscan.let.cop.com.service.UserInfVO)
     */
