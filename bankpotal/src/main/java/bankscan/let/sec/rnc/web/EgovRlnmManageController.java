package bankscan.let.sec.rnc.web;
...
import bankscan.let.sec.rnc.service.EgovRlnmManageService;
...
//		return "/sec/rnc/EgovRlnmCnfirm";
	...
	public String rlnmPinCnfirm(Model model, @RequestParam Map<String, Object> commandMap, HttpServletRequest request) throws Exception {
		...
		return "/sec/rnc/EgovRlnmPinCnfirm";
	}
