package bankscan.let.uss.ion.mtg.web;

import java.util.Calendar;
import java.util.List;
import java.util.Map;

import bankscan.com.cmm.ComDefaultCodeVO;
import bankscan.com.cmm.EgovMessageSource;
import bankscan.com.cmm.LoginVO;
//import bankscan.com.cmm.annotation.IncludedInfo;
import bankscan.com.cmm.service.EgovCmmUseService;
import bankscan.com.cmm.service.EgovFileMngService;
import bankscan.com.cmm.service.EgovFileMngUtil;
import bankscan.com.cmm.service.FileVO;
//import bankscan.com.cmm.util.EgovUserDetailsHelper;
import egovframework.rte.fdl.security.userdetails.util.EgovUserDetailsHelper;
import bankscan.let.uss.ion.mtg.service.EgovMtgPlaceManageService;
import bankscan.let.uss.ion.mtg.service.MtgPlaceManage;
import bankscan.let.uss.ion.mtg.service.MtgPlaceManageVO;
import bankscan.let.uss.ion.mtg.service.MtgPlaceResve;
import bankscan.let.utl.fcc.service.EgovDateUtil;
...
public class EgovMtgPlaceManageController {
    ...
    public String selectMtgPlaceManageListView() throws Exception {
        ...
        //return "bankscan/let/uss/ion/mtg/EgovMtgPlaceManageList";
    	return "/uss/ion/mtg/EgovMtgPlaceManageList";
    }
    ...
    @RequestMapping(value="/uss/ion/mtg/selectMtgPlaceManage.do")
	 public String selectMtgPlaceManage(@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		if(sCmd.equals("update")){
			return "/uss/ion/mtg/EgovMtgPlaceUpdt";
		}else{
			return "/uss/ion/mtg/EgovMtgPlaceDetail";
		}
	}
    ...
    @RequestMapping(value="/uss/ion/mtg/insertViewMtgPlace.do")
	 public String insertViewMtgPlaceManage(@ModelAttribute("mtgPlaceManage") MtgPlaceManage mtgPlaceManage,
    	...
    	return "/uss/ion/mtg/EgovMtgPlaceRegist";
	}
    ...
    @RequestMapping(value="/uss/ion/mtg/selectMtgPlaceImage.do")
	 public String selectMtgPlaceImage(@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
    	...
    	model.addAttribute("message", egovMessageSource.getMessage("success.common.select"));
		return "/uss/ion/mtg/EgovMtgPlaceImageDetail";
	}
...
*/
		...
		//return "bankscan/let/uss/ion/mtg/EgovMtgPlaceResveManageList";
		return "/uss/ion/mtg/EgovMtgPlaceResveManageList";
	}
	...
	@RequestMapping(value="/uss/ion/mtg/selectMtgPlaceResveManage.do")
	 public String selectMtgPlaceResveManage(	@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
    	...
    	//로그인 객체 선언 - ㅡModify by bsjang 
    	Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
    	if(!isAuthenticated) {
    		mtgPlaceManageVO_Temp.setMtgPlaceTemp4("");
    		mtgPlaceManageVO_Temp.setMtgPlaceTemp5("");
...
//
//    	model.addAttribute("mtgPlaceManageVO",  mtgPlaceManageVO_Temp);
		return "/uss/ion/mtg/EgovMtgPlaceResveRegist";
	}
	 ...
	 */
	 ...
	 public String selectMtgPlaceResveManageDetail(	@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		if(sCmd.equals("detail")){
	    	...
	    	model.addAttribute("mtgPlaceManageVO",  mtgPlaceManageVO_Temp);
			return "/uss/ion/mtg/EgovMtgPlaceResveDetail";
		}else{
		    model.addAttribute("mtgPlaceManageVO",  mtgPlaceManageVO_Temp);
			return "/uss/ion/mtg/EgovMtgPlaceResveUpdt";
		}
	}
	 ...
	 */
	 ...
	 public String mtgPlaceResveDplactCeck(  @ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		return "/uss/ion/mtg/EgovMtgPlaceResveDplactCeck";
	}
