package bankscan.let.uss.umt.web;
...
import bankscan.let.uss.umt.service.EgovUserManageService;
import bankscan.let.uss.umt.service.UserDefaultVO;
import bankscan.let.uss.umt.service.UserManageVO;
...
public class EgovUserManageController {
	 ...
	 * @throws Exception
	 */
/* 이것은 중복해서 정의되어 있음 따라서 EgovManagerController.java 것으로 사용하도록 함
 * 
