package bankscan.let.utl.wed.web;
...
import bankscan.com.cmm.service.EgovProperties;
import bankscan.let.utl.fcc.service.EgovFileUploadUtil;
import bankscan.let.utl.fcc.service.EgovFormBasedFileUtil;
import bankscan.let.utl.fcc.service.EgovFormBasedFileVo;
...
public class EgovWebEditorImageController {
	...
	return "/utl/wed/EgovInsertImage";
    }
    ...
    public String imageUploadCk(@RequestParam(value="CKEditorFuncNum", required=false) String ckEditorFuncNum, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
    	...
    	uploadImageFiles(request, model);
		return "/utl/wed/EgovUploadImageComplete";
    }
